...
@export var minimum_command_strength := 0.7
@export var spin_impulse := 2.8
@export var flip_impulse := 3.2
@export var cork_yaw_impulse := 2.25
@export var cork_roll_impulse := 2.55
@export var air_yaw_trim_acceleration := 2.4
