...
@export_range(0.0, 0.3, 0.005) var packed_form_contrast := 0.115
@export_range(0.0, 0.3, 0.005) var groomed_form_contrast := 0.11
@export_range(0.0, 0.3, 0.005) var powder_form_contrast := 0.1
@export_range(0.0, 0.3, 0.005) var steepness_contrast := 0.055
@export_range(0.005, 0.2, 0.001) var medium_variation_scale := 0.028
@export_range(0.0, 0.25, 0.005) var packed_medium_variation := 0.09
@export_range(0.0, 0.25, 0.005) var groomed_medium_variation := 0.08
@export_range(0.0, 0.25, 0.005) var powder_medium_variation := 0.1
@export_range(0.001, 0.05, 0.001) var broad_variation_scale := 0.018
@export_range(0.0, 0.25, 0.005) var packed_broad_variation := 0.13
@export_range(0.0, 0.25, 0.005) var groomed_broad_variation := 0.12
@export_range(0.0, 0.25, 0.005) var powder_broad_variation := 0.14
...
@export var packed_shadow_tint := Color(0.775, 0.795, 0.805)
@export var groomed_color := Color(0.955, 0.96, 0.96)
@export var groomed_shadow_tint := Color(0.79, 0.805, 0.815)
@export var powder_color := Color(0.965, 0.975, 0.98)
@export var powder_shadow_tint := Color(0.785, 0.805, 0.825)
