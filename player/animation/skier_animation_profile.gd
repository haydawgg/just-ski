...
@export var crash_tumble_speed: float = 4.0
@export var crash_tumble_limit: float = 0.40
@export var crash_directional_response: float = 0.55
...
@export var crash_recovery_duration: float = 0.50
@export var crash_recovery_recenter_portion: float = 0.45
@export var crash_recovery_ik_start: float = 0.38
@export var crash_ski_plane_limit_degrees: float = 42.0
@export var crash_ski_plane_response: float = 14.0
